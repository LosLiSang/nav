...
export function ProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 text-neutral-800 shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-150">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-neutral-100 pb-3.5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-neutral-900">个人中心与数据管理</h2>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="mt-5 space-y-5 text-xs">
          {/* 1. Avatar & Nickname */}
          <div>
            <label className="block font-medium text-neutral-800 mb-2.5">
              个人头像与昵称
            </label>
            <div className="flex items-center gap-3.5 rounded-xl border border-neutral-200 p-3 bg-neutral-50/50">
              <img
                src={customAvatar}
                alt="Avatar"
              ...
              <div className="flex-1 space-y-1.5">
                <input
                  ...
                  placeholder="输入昵称"
                  className="w-full rounded-lg border border-neutral-200 bg-white px-2.5 py-1.5 text-xs font-medium text-neutral-800 outline-none focus:border-orange-500"
                />
            ...
            <div className="mt-2.5">
              <span className="text-[11px] text-neutral-500 mb-1.5 block">选择预设头像：</span>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="w-full rounded-lg border border-neutral-200 bg-neutral-50 px-2.5 py-1.5 text-xs outline-none focus:border-orange-500 focus:bg-white"
              />
            </div>
          </div>
          ...
          <div className="border-t border-neutral-100 pt-4">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button
                ...
                className="flex items-center justify-center gap-1.5 rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 font-medium text-neutral-700 shadow-sm transition hover:bg-neutral-100"
              >
                <Download className="h-4 w-4 text-blue-500" />
                <span>导出全部备份 (JSON)</span>
              </button>

              <label className="flex cursor-pointer items-center justify-center gap-1.5 rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 font-medium text-neutral-700 shadow-sm transition hover:bg-neutral-100">
            ...
            <div className="mt-3">
              {!showConfirmReset ? (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-1.5 rounded-xl border border-red-100 bg-red-50/60 py-2 text-xs text-red-600 transition hover:bg-red-50"
                >
                ...
                <div className="rounded-xl border border-red-200 bg-red-50 p-3">
                  ...
                  <div className="mt-2.5 flex justify-end gap-2">
                    <button
                      ...
                      className="rounded-lg bg-white px-3 py-1 text-xs text-neutral-600 border border-neutral-200 hover:bg-neutral-50"
                    >
                      取消
                    </button>
                    <button
