...
export function BottomSection({
  ...
  // Periodic TOTP calculation (every second)
  useEffect(() => {
  ...
  return (
    <section className="relative mt-5">
      {/* Cute typing cat illustration / Bongo Cat floating above widget card! */}
      ...
      >
        {/* Tabs header */}
        <div className="flex items-center gap-2 border-b border-neutral-100 dark:border-neutral-800 px-4 py-2.5">
          <button
            type="button"
        ...
        {settings.activeWidgetTab === 'memo' && (
          <div className="flex flex-col p-4">
            ...
            <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 max-h-[220px] overflow-y-auto pr-1 text-xs">
              {memos.length === 0 ? (
                <div className="col-span-full py-8 text-center text-neutral-400">暂无便签</div>
              ) : (
                memos.map((memo) => (
                  <div
                    key={memo.id}
        ...
        {settings.activeWidgetTab === 'calendar' && (
          <div className="p-4 text-xs">
            ...
            <div className="grid grid-cols-7 gap-2 text-center font-medium text-neutral-400">
              <span>一</span>
              <span>二</span>
              <span>三</span>
              <span>四</span>
        ...
        {settings.activeWidgetTab === 'totp' && (
          <div className="flex flex-col p-4 text-xs">
            <div className="flex items-center justify-between pb-3">
              <span className="text-neutral-500 font-medium">离线 2FA 动态口令 (每 30 秒自动计算)</span>
              <button
                type="button"
              ...
              >
                ...
                <span>{showAddTotp ? '收起表单' : '添加 2FA 账号'}</span>
              </button>
            </div>
            ...
            {showAddTotp && (
              ...
              >
                ...
                <input
                  ...
                  placeholder="2FA 密钥 (Base32 格式，例如 JBSWY3DPEHPK3PXP)"
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 md:grid-cols-3 max-h-[220px] overflow-y-auto pr-1">
              {totpAccounts.length === 0 ? (
                <div className="col-span-full py-6 text-center text-neutral-400">暂无 2FA 账号</div>
              ) : (
                totpAccounts.map((acc) => {
                  ...
                  return (
                    <div
                      key={acc.id}
                      className="flex items-center justify-between rounded-xl border border-neutral-200/80 dark:border-neutral-800 bg-neutral-50/60 dark:bg-[#27272a]/60 p-3"
                    >
                      <div>
                        <div className="font-medium text-neutral-800 dark:text-neutral-200">{acc.name}</div>
                        <div className="font-mono text-lg font-bold tracking-wider text-blue-600">
                          {formattedCode}
                        </div>
                      </div>
          ...
          <div className="flex flex-col items-center p-4 text-xs">
            ...
            {qrDataUrl ? (
              <div className="mt-3 flex flex-col items-center">
                <img src={qrDataUrl} alt="QR Code" className="h-32 w-32 rounded-lg shadow-sm bg-white p-1" />
              ...
              <div className="py-8 text-neutral-400">请输入内容生成二维码</div>
            )}
          </div>
        )}
            ...
            <div className="mt-3 space-y-2.5">
              {devToolTab !== 'uuid' && (
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#27272a] text-neutral-800 dark:text-neutral-100 px-3 py-2 text-xs outline-none focus:border-orange-400"
                />
              )}
